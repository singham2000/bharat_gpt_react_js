            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-xl-5 col-lg-12">
                        <video id="corover_video" className="w-100 rounded-1" autoPlay muted loop poster={Poster}>
                                ...
                                >
                                    <SwiperSlide style={{ height: 'max-content' }}>
                                        ...
                                        <div class="tp-about-item-content">
                                            <h4 class="about-title" style={{ fontSize: '18px', important: 'true' }}>
                                                Build your Organization’s GenAI powered bots using
                                                the sensational and proven platform from CoRover.
                                            </h4>
                                    ...
                                    <SwiperSlide style={{ height: 'max-content' }}>
                                        <div class="tp-about-item mb-30">
                                            ...
                                            <div class="tp-about-item-content">
                                                <h5 class="about-title" style={{ fontSize: '18px', important: 'true' }} >
                                                    We enable enterprises and other communities to
                                                    develop their function-specific Chatbots.
                                                </h5>
                                                <p style={{ lineHeight: '24px', important: 'true' }}>
                                                    We invite business and development community to
                                                    sign up and witness the magic of building their
