...
const Awards_and_recognition = () => {
    return (
        <div>
            <section className="breadcrumb__area breadcrumb-style pt-20 pb-20 p-relative z-index-1" data-background="">
                ...
                <div className="container">
                    <div className="row">
                        <div className="col-lg-4 col-sm-6">
                            <div className="tp-team-wrapper p-relative mb-30">
                                <div className="tp-team-wrapper-thumb ">
                                    <img height="250px" src="assets/img/awards/award_1.PNG" alt="" />
                                </div>
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="tp-team-wrapper p-relative mb-30">
                                <div className="tp-team-wrapper-thumb ">
                                    <img height="250px" src="assets/img/awards/award_2.PNG" alt="" />
                                </div>
                                <div className="tp-team-wrapper-content d-flex justify-content-between">
                                    <div className="tp-team-wrapper-content-text">
                                        <h3 className="team-title">
                        ...
                        <div className="col-lg-4 col-sm-6">
                            <div className="tp-team-wrapper p-relative mb-30">
                                <div className="tp-team-wrapper-thumb ">
                                    <img height="250px" src="assets/img/awards/award_3.PNG" alt="" />
                                </div>
                                <div className="tp-team-wrapper-content d-flex justify-content-between">
                                    <div className="tp-team-wrapper-content-text">
                                        <h3 className="team-title">
                                        ...
                                        <p style={{ fontSize: '16px', color: '#9f9b94' }}>
                                            Best Company for Data Scientists,
                    ...
                    <div className="col-lg-12 mb-20 col-sm-6 d-flex justify-content-center align-items-center">
                        <div className="tp-portfolio-details-right">
                            <div className="tp-portfolio-details-btn" style={{ background: 'black' }}>
                            <Link style={{ textDecoration: 'none', background: 'black' }} to={'/awards'}>
                            Show More
                            </Link>
